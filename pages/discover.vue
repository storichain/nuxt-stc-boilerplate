    ...
    <section>
        <div class="header mhd">
            ...
            <div class="hnav_hd">
                <div class="nav_wrap">
                    <ul class="hnav">
                        <li class="m1 selected"><a href="#"><strong>Discover</strong></a></li>
                        <li class="m2"><a href="#"><strong>Feed</strong></a></li>
                        <li class="m3"><a href="#"><strong>Desk</strong></a></li>
                        <li class="m4"><a href="#"><strong>Cowork</strong></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        -->
            ...
            <div class="user_info">
                <div class="user_pf">
                    <div class="user_img"><img src="/images/del/u.png" alt=""></div>
                    <div class="user_id">
                        <div class="user_email">leejunes@storichain.com</div>
                        <div class="user_wid">@my_writter_id</div>
                    </div>
                </div>
                <div class="user_follow">
                    <span class="ufl"><strong>188</strong> following</span> <span class="ufr"><strong>2922</strong> follower</span>
                </div>
            ...
            <ul class="mn mn2">
                ...
                <li class="mn25"><a href="#">설정 및 계정 정보</a></li>
                <li class="mn26"><a href="#">문의 하기</a></li>
                <li class="mn27"><a href="#">로그아웃</a></li>
            </ul>
            </div>

            <div class="footer">
                <p class="copy">copyright &copy; 2018 STORICHAIN <br /> ALL RIGHTS RESERVED</p>
                <ul class="cp_lk">
        ...
        <div class="container ">
            <form action="">
                <fieldset>
                    <div class="search_area">
                        <div class="ct_wrap">
                            <div class="sch_input">
                                <input type="search" class="inp_txt" name="" placeholder="" title="search">
            ...
            <div class="category">
                <div class="ct_wrap">
                    <ul class="cat_lst">
                        <li><a href="#">NEW</a></li>
                        <li><a href="#">Open Stories</a></li>
                        <li><a href="#" class="selected">Pro Stories</a></li>
                        <li><a href="#">Contesting Stories</a></li>
                        <li><a href="#">Trading Stories</a></li>
                        <li><a href="#">Funding Stories</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="fx_btn ct_lk">
                <ul class="drt_btn">
                    ...
                    <li><a href="#" class="btn_back"><span>back</span></a></li>
                    <li><a href="#" class="btn_down"><span>down</span></a></li>
                </ul>
                <ul class="rd_btn">
                    <li><a href="#" class="btn_lk_lbl"><span class="blind">Label</span></a></li>
                </ul>
            </div>
        </div>

        <!-- label layer 추가해야함 -->
        <div class="label_layer">
        </div>

        <!-- alert -->
        <div class="alert">
            <div class="alert_wrap">
                <p>Please confirm you email to certify</p>
                <p class="fcp">If you don't confirm within 7days, your ID will be deleted</p>
                <button type="button" class="btn btn_alert_close"><span class="blind">닫기</span></button>
            </div>
        </div>

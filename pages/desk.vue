    ...
    <section>
        <div class="header mhd">
            ...
            <div class="hnav_hd">
                <div class="nav_wrap">
                    <ul class="hnav">
                        <li class="m1"><a href="#"><strong>Discover</strong></a></li>
                        <li class="m2"><a href="#"><strong>Feed</strong></a></li>
                        <li class="m3 selected"><a href="#"><strong>Desk</strong></a></li>
        ...
        <div class="container">
            ...
            <div class="category">
                <div class="ct_wrap">
                    <ul class="cat_lst">
                        <li><a href="#">나의작성모두</a></li>
                        <li><a href="#">비공개</a></li>
                        <li><a href="#" class="selected">시리즈</a></li>
                        <li><a href="#">피드공개</a></li>
                        <li><a href="#">전체공개</a></li>
                        <li><a href="#">링크공개</a></li>
                    </ul>
                ...
                <div class="ct_wrap">
                    <ul class="content_lst">
                        ...
                        <li>
                            ...
                            <div class="ct_info">
                                <div class="ct_info_wrap">
                                    <h2><a href="#">방자는 18세 2화 <img src="/images/ic_series_2.png" width="15" alt="시리즈"></a></h2>
                                    <div class="opr"><a href="#" class="btn_opr">공개범위 : <strong>전체</strong></a></div>
                                    <ul class="stats_lst">
                                        <li class="grph"><span>1000</span></li>
                                        <li class="cutin"><span>372</span></li>
                    ...
                    <div class="fbtn">
                        <button type="button" class="btn btn_more">더보기</button>
                    </div>
                </div>
            </div>
            ...
            <div class="fx_btn ct_lk">
                ...
                <ul class="rd_btn">
                    <li><a href="#" class="btn_lk_srs"><span class="blind">시리즈만들기</span></a></li>
                    <li><a href="#" class="btn_lk_wrt"><span class="blind">작성하기</span></a></li>
                </ul>
            </div>
